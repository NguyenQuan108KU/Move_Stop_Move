...
public class CameraFollow : MonoBehaviour
{
    ...
    private void LateUpdate()
    {
        ...
        if (GameController.instance.uiManager.enemyAliveTotal <= 0){
        ...
        mainCamera.fieldOfView = Mathf.SmoothDamp(mainCamera.fieldOfView, targetFOV, ref fovVelocity, 1.4f);            // SmoothDamp FOV → chuyển đổi mượt giữa FOV hiện tại và target
    }
}
