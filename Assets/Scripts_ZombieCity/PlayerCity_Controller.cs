...
public class PlayerCity_Controller : MonoBehaviour
{
    ...
    public void AttackTrigle()
    {
        ...
        EnemyController firstEnemyDetected = null;      // Biến lưu enemy đầu tiên phát hiện
        ...
        foreach (var hit in colliders)
        {
            ...
            {
                firstEnemyDetected = hit.GetComponent<EnemyController>(); // Lấy component Enemy từ collider
    ...
    private IEnumerator ShootDoubleShot()
    {
    ...
    public void SetWinner()
    {
        ...
        if (zombieAlive <= 0)
        {
            zombieAlive = 0; // Đảm bảo giá trị không xuống âm
